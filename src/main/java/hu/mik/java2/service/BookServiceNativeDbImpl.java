...
public class BookServiceNativeDbImpl implements BookService {
	...
	public List<Book> listBooks() {
		...
		try {
			...
			preparedStatement = connection
					.prepareStatement("SELECT id, author, title, description, pub_year FROM t_book b ORDER BY b.id");
	...
	public Book getBookById(Integer id) {
		...
		try {
			connection = this.dataSource.getConnection();
			preparedStatement = connection
					.prepareStatement("SELECT id, author, title, description, pub_year FROM t_book b WHERE b.id = ?");
	...
	public Book updateBook(Book book) {
		...
		try {
			connection = this.dataSource.getConnection();
			preparedStatement = connection.prepareStatement(
					"UPDATE t_book SET author=?, title=?, description=?, pub_year=? WHERE id=?");
